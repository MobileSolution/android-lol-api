...
public interface RetrofitApiClient {
    ...
    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    ...
    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/champion")
    com.mobilesolutions.lolapi.models.statics.ChampionListDto getChampionList(@Path("region") String region, @Query("champData") String champData, @Query("api_key") String apiKey);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/champion")
    void getChampionList(@Path("region") String region, @Query("champData") String champData, @Query("api_key") String apiKey, final Callback<com.mobilesolutions.lolapi.models.statics.ChampionListDto> callback);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/champion")
    Observable<com.mobilesolutions.lolapi.models.statics.ChampionListDto> getChampionListRx(@Path("region") String region, @Query("champData") String champData, @Query("api_key") String apiKey);
    ...
    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/item")
    ItemListDto getItemList(@Path("region") String region, @Query("itemListData") String itemListData, @Query("api_key") String apiKey);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/item")
    void getItemList(@Path("region") String region, @Query("itemListData") String itemListData, @Query("api_key") String apiKey, final Callback<ItemListDto> callback);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/item")
    Observable<ItemListDto> getItemListRx(@Path("region") String region, @Query("itemListData") String itemListData, @Query("api_key") String apiKey);
    ...
    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/item/{id}")
    ItemDto getItemById(@Path("region") String region, @Path("id") long id, @Query("itemListData") String itemListData, @Query("api_key") String apiKey);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/item/{id}")
    void getItemById(@Path("region") String region, @Path("id") long id, @Query("itemListData") String itemListData, @Query("api_key") String apiKey, final Callback<ItemDto> callback);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/item/{id}")
    Observable<ItemDto> getItemByIdRx(@Path("region") String region, @Path("id") long id, @Query("itemListData") String itemListData, @Query("api_key") String apiKey);
    ...
    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/mastery")
    MasteryListDto getMasteryList(@Path("region") String region, @Query("masteryListData") String masteryListData, @Query("api_key") String apiKey);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/mastery")
    void getMasteryList(@Path("region") String region, @Query("masteryListData") String masteryListData, @Query("api_key") String apiKey, final Callback<MasteryListDto> callback);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/mastery")
    Observable<MasteryListDto> getMasteryListRx(@Path("region") String region, @Query("masteryListData") String masteryListData, @Query("api_key") String apiKey);
    ...
    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/mastery/{id}")
    MasteryDto getMasteryById(@Path("region") String region, @Path("id") long id, @Query("masteryListData") String masteryListData, @Query("api_key") String apiKey);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/mastery/{id}")
    void getMasteryById(@Path("region") String region, @Path("id") long id, @Query("masteryListData") String masteryListData, @Query("api_key") String apiKey, final Callback<MasteryDto> callback);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/mastery/{id}")
    Observable<MasteryDto> getMasteryByIdRx(@Path("region") String region, @Path("id") long id, @Query("masteryListData") String masteryListData, @Query("api_key") String apiKey);
    ...
    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/rune")
    RuneList getRuneList(@Path("region") String region, @Query("runeListData") String runeListData, @Query("api_key") String apiKey);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/rune")
    void getRuneList(@Path("region") String region, @Query("runeListData") String runeListData, @Query("api_key") String apiKey, final Callback<RuneList> callback);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/rune")
    Observable<RuneList> getRuneListRx(@Path("region") String region, @Query("runeListData") String runeListData, @Query("api_key") String apiKey);
    ...
    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/rune/{id}")
    RuneDto getRuneById(@Path("region") String region, @Path("id") long id, @Query("runeListData") String runeListData, @Query("api_key") String apiKey);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/rune/{id}")
    void getRuneById(@Path("region") String region, @Path("id") long id, @Query("runeListData") String runeListData, @Query("api_key") String apiKey, final Callback<RuneDto> callback);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/rune/{id}")
    Observable<RuneDto> getRuneByIdRx(@Path("region") String region, @Path("id") long id, @Query("runeListData") String runeListData, @Query("api_key") String apiKey);
    ...
    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/summoner-spell")
    SummonerSpellListDto getSummonerSpellList(@Path("region") String region, @Query("spellData") String spellData, @Query("api_key") String apiKey);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/summoner-spell")
    void getSummonerSpellList(@Path("region") String region, @Query("spellData") String spellData, @Query("api_key") String apiKey, final Callback<SummonerSpellListDto> callback);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/summoner-spell")
    Observable<SummonerSpellListDto> getSummonerSpellListRx(@Path("region") String region, @Query("spellData") String spellData, @Query("api_key") String apiKey);
    ...
    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/summoner-spell/{id}")
    SummonerSpellDto getSummonerSpellById(@Path("region") String region, @Path("id") long id, @Query("spellData") String spellData, @Query("api_key") String apiKey);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/summoner-spell/{id}")
    void getSummonerSpellById(@Path("region") String region, @Path("id") long id, @Query("spellData") String spellData, @Query("api_key") String apiKey, final Callback<SummonerSpellDto> callback);

    @Headers("Cache-Control: public, max-age=640000, s-maxage=640000,max-stale")
    @GET("/api/lol/static-data/{region}/v1.2/summoner-spell/{id}")
    Observable<SummonerSpellDto> getSummonerSpellByIdRx(@Path("region") String region, @Path("id") long id, @Query("spellData") String spellData, @Query("api_key") String apiKey);
